    ...
    return (
        <div className ='headerContainer'>
            ...
            <div className='headerContent'>
                ...
                <div>
                    <h2>-Respect</h2>
                    <p> <b>Everyone matters, Everyone contributes.</b> As a community, we value and consider everyone's thoughts, feelings, and opinions.
                ...
                <h2>-Commitment</h2>
                <p>We support and defend one another. We have strength of character and everything that we do is for the betterment and best
                ...
                <div className='coreValues'>
                    ...
                    <p> 
                        ...
                        so we can create an atmosphere and environment where anything is possible(especially when working together).
                    </p>
                </div>
            </div>
        </div>
